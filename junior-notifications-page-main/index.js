const usersActivity = [
  {
    ...
    userInteraction: "reacted to your recent post",
    userInteracted: "My first tournament today!",
    activityState: "new",
    interactionDate: "1m ago",
    commentedPicture: "none",
    userMsg: "none",
    interactionType: "post-reaction",
  },
  {
    userPosition: 2,
    userAvatar: "./assets/images/avatar-angela-gray.webp",
    userName: "Angela Gray",
    userInteraction: "followed you",
    userInteracted: "",
    activityState: "new",
    interactionDate: "5m ago",
    commentedPicture: "none",
    userMsg: "none",
  ...
  },
  {
    ...
    userInteraction: "has joined your group",
    userInteracted: "Chess Club",
    activityState: "new",
    interactionDate: "1 day ago",
    commentedPicture: "none",
    userMsg: "none",
  ...
  },
  {
    ...
    userInteraction: "sent you a private message",
    userInteracted: "",
    activityState: "old",
    interactionDate: "5 days ago",
    commentedPicture: "none",
    userMsg:
      "Hello, thanks for setting up the Chess Club. I've been a member for a few weeks now and I'm already having a lots of fun and improving my game.",
  ...
  },
  {
    ...
    userInteraction: "reacted to your recent post",
    userInteracted: "5 end-game strategies to increase your win rate",
    activityState: "old",
    interactionDate: "2 weeks ago",
    commentedPicture: "none",
    userMsg: "none",
    interactionType: "post-reaction",
  },
  {
    ...
    userName: "Anna Kim",
    userInteraction: "left the group",
    userInteracted: "Chess Club",
    activityState: "old",
    interactionDate: "2 weeks ago",
    commentedPicture: "none",
...
function stateCount() {
  ...
  document.querySelector("#active-status-number span").textContent =
    activeStatusNumber;
}
